...
# ============================================================
# MIGRATION COMPATIBILITY STUBS (managed=False)
# These models were removed in migration 0011_remove_almacen_models.
# They exist here ONLY so Django can resolve FK references to them
# during in-process migration execution (auto_create_schema=True).
# The actual DB tables are managed entirely by migrations.
# DO NOT add fields or logic here - stubs only.
# ============================================================
...
class TrasladoStock(models.Model):
    class Meta:
        managed = False
        app_label = 'inventario'
        db_table = 'inventario_trasladostock'
...
class HistorialAsignacionAlmacen(models.Model):
    class Meta:
        managed = False
        app_label = 'inventario'
        db_table = 'inventario_historialasignacionalmacen'
